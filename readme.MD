...
│           │
│           ├── karate/                   # Exemplos básicos do Karate
│           │   ├── sample.feature
│           │   ├── SampleTest.java
│           │   ├── customTags.feature
│           │   └── ...
...
```gherkin
@produtos
Feature: Gerenciamento de Produtos (Requer Autenticação)
...
```gherkin
  @validacao-schema
  Scenario: Validar estrutura da resposta ao listar usuários
    Given path ''
    When method GET
    Then status 200
    And match response ==
